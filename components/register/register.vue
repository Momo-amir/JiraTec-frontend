<template>
	<div class="max-w-md mx-auto w-full bg-base-100 p-8 border border-base-300 rounded-lg shadow-md">
		...
		<form @submit.prevent="handleSubmit">
			...
			<button type="submit" class="w-full bg-primary text-base-100 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium hover:bg-primary-focus focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary hover:rounded-none duration-200">Register</button>
		</form>
