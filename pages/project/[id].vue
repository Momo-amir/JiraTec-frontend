	...
	<div v-if="project">
		<div class="flex flex-row justify-between mx-10 mt-5">
			...
			<div class="">
				...
				<button @click="showUserModal = true" class="mt-4 px-4 py-2 bg-primary text-base-100 rounded-md">Add Users to Project</button>
			</div>
		</div>

		<!-- Kanban Board Component -->
		<div class="m-10">
			<KanbanBoard :tasks="project.tasks ?? []" @taskUpdated="handleTaskUpdated" @taskDeleted="handleTaskDeleted" @editTask="handleTaskEdited" />
		</div>
